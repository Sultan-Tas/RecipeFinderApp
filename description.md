...
- Another feature would be planer for meals for the week
...
1. User registration - creation of accounts with email and password
2. Search feature - search for recipes by different variables through API
3. Weekly planner - planner for the next week with ingredients that you will need